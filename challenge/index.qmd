...
## <span class="material-symbols-outlined">newspaper</span> News {id="news"}

- (06/01/26) **Competition Kick-off!** We are excited to announce the official launch of the GeoAI Arctic Challenge. 

## <span class="material-symbols-outlined">landscape_2</span> What is Retrogressive Thaw Slumps (RTS)? {id="what-is-retrogressive-thaw-slumps-rts"}
...
## <span class="material-symbols-outlined">info</span> About the Challenge {id="about-the-challenge"}
...
## <span class="material-symbols-outlined">handshake</span> Collaborators {id="collaborators"}
...
## <span class="material-symbols-outlined">groups</span> Partners {id="partners"}
...
## <span class="material-symbols-outlined">paid</span> Sponsors {id="sponsors"}

![](../assets/clients/NSF.png){width=20%}

## <span class="material-symbols-outlined">library_books</span> References {id="references"}

The GeoAI Arctic Challenge builds upon a RTS dataset and cutting-edge multimodal GeoAI models. We encourage participants to cite the following works when using the dataset or baseline model:
...
## <span class="material-symbols-outlined">image</span> Dataset Samples {id="dataset-samples"}
