...
A central hub for help, learning materials, and policies for the **GeoAI RTS Mapping Challenge**.
...
<div class="card">
  ...
  <p><a href="mailto:geoai-rts@asu.edu">geoai-rts@asu.edu</a></p>
</div>
...
### 🧰 Official
- **Baseline notebook:** `../assets/baseline_notebook.ipynb`  
...
Please cite the dataset and baseline model:

**Yang et al., 2023 — Dataset**
